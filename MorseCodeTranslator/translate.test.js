...
describe("Morse Code Translation", () => {
    ...
    test("autoTranslate should return empty string for invalid characters", () => {
        expect(autoTranslate("~!@#")).toBe("Argument must be a string"); 
        expect(autoTranslate("HELLO @123")).toBe("Argument must be a string"); 
        expect(autoTranslate("HELLO *&^")).toBe("Argument must be a string"); 
    });
